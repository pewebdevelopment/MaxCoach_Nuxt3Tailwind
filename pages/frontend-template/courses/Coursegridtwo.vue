<template>
  <div class="dark:bg-[#161821] bg-white w-12/12 px-24">
    <div class="py-[100px]">
      <courseheader>
        <template v-slot:title><span class="dark:text-white text-[#333] "> Courses Grid 02 </span></template>
      </courseheader>
    </div>
    <div>
      <div class="flex justify-between items-start">
        <p class="text-[15px] dark:text-[#ddd] text-[#696969]  font-normal leading-[1.74]">
