  ...
  <header class="header relative" style="position: fixed; top: 0; left: 0; width: 100%; z-index: 999">
    <div
      ...
      <div class="container grid grid-flow-col xl:grid-cols-[22%_minmax(56%,_1fr)_22%] items-center px-3.8 3xl:px-37">
        <NuxtLink class="inline-block max-w-[120px] sm:max-w-[158px]" to="/frontend-template"><img :src="
          darkMode
            ? '/images/logo/light-logo.png'
            : '/images/logo/dark-logo.png'
        " alt="Logo" width="158" height="26" /></NuxtLink>
          ...
          <ul aria-label="Main Menu" role="menubar">
            <li v-if="darkMode" class="inline-block px-2.5 2xl:px-[17px] py-[29px] group" role="none">
              <NuxtLink rel="noopener noreferrer"
                class="darkMain font-medium 2xl:text-[16px] flex items-center leading-snug text-secondary dark:text-white" to="#!"
                id="nav-1" role="menuitem" tabindex="0" aria-haspopup="true" aria-expanded="false">
                Home<i class="fa fa-chevron-down ml-2 text-xs"></i></NuxtLink>
              <div
                ...
                <div class="px-3.8 shrink-0 grow-0 w-1/4 basis-1/4">
                  ...
                  <ul>
                    <li class="relative">
                      <NuxtLink class="leading-relaxed block font-medium py-2 hover:text-heading dark:hover:text-primary"
                        to="/frontend-template">MaxCoach Education<span
                    ...
                    <li class="relative">
                      <NuxtLink class="leading-relaxed block font-medium py-2 hover:text-heading dark:hover:text-primary"
                        to="/frontend-template/home/distantlearning">Distant Learning<span
                          class="inline-flex justify-center items-center leading-none text-white bg-strawGradient pt-1 px-2 pb-[3px] text-[11px] rounded-sm ml-2.5 font-bold tracking-wide uppercase">hot</span>
                      </NuxtLink>
                    </li>
                    <li class="relative">
                  ...
                  <ul>
                    <li class="relative">
                      <NuxtLink class="leading-relaxed block font-medium py-2 hover:text-heading pointer-events-none"
                        to="/frontend-template">Health Coaching<span
                    ...
                    <li class="relative">
                      <NuxtLink class="leading-relaxed block font-medium py-2 hover:text-heading pointer-events-none"
                        to="/frontend-template">Gym Coaching<span
                          class="inline-flex justify-center items-center leading-none text-white bg-primary pt-1 px-2 pb-[3px] text-[11px] rounded-sm ml-2.5 font-bold tracking-wide uppercase">coming
                          soon</span></NuxtLink>
                    </li>
                    <li class="relative">
                      <NuxtLink class="leading-relaxed block font-medium py-2 hover:text-heading pointer-events-none"
                        to="/frontend-template">Business<span
                          class="inline-flex justify-center items-center leading-none text-white bg-primary pt-1 px-2 pb-[3px] text-[11px] rounded-sm ml-2.5 font-bold tracking-wide uppercase">coming
                          soon</span></NuxtLink>
                    </li>
                    <li class="relative">
                      <NuxtLink class="leading-relaxed block font-medium py-2 hover:text-heading pointer-events-none"
                        to="/frontend-template">Artist<span
                          class="inline-flex justify-center items-center leading-none text-white bg-primary pt-1 px-2 pb-[3px] text-[11px] rounded-sm ml-2.5 font-bold tracking-wide uppercase">coming
                          soon</span></NuxtLink>
                    </li>
                    <li class="relative">
                      <NuxtLink class="leading-relaxed block font-medium py-2 hover:text-heading pointer-events-none"
                        to="/frontend-template">Kitchen Coach<span
                          class="inline-flex justify-center items-center leading-none text-white bg-primary pt-1 px-2 pb-[3px] text-[11px] rounded-sm ml-2.5 font-bold tracking-wide uppercase">coming
                          soon</span></NuxtLink>
                    </li>
                    <li class="relative">
                      <NuxtLink class="leading-relaxed block font-medium py-2 hover:text-heading pointer-events-none"
                        to="/frontend-template">Motivation<span
                          class="inline-flex justify-center items-center leading-none text-white bg-primary pt-1 px-2 pb-[3px] text-[11px] rounded-sm ml-2.5 font-bold tracking-wide uppercase">coming
                          soon</span></NuxtLink>
                    </li>
                  </ul>
            ...
            <li v-else class="inline-block px-2.5 2xl:px-[17px] py-[29px] group" role="none">
              <NuxtLink rel="noopener noreferrer"
                class="main font-medium 2xl:text-[16px] flex items-center leading-snug text-secondary dark:text-white" to="#!"
                id="nav-1" role="menuitem" tabindex="0" aria-haspopup="true" aria-expanded="false">
                Home<i class="fa fa-chevron-down ml-2 text-xs"></i></NuxtLink>
              <div
                class="w-[1170px] flex flex-wrap absolute z-20 top-full mt-5 invisible opacity-0 pt-7.5 pb-[34px] px-3.8 shadow-2md shadow-black/5 bg-white border-b-4 border-b-primary transition-all duration-300 left-1/2 -translate-x-1/2 group-hover:visible group-hover:opacity-100 group-hover:mt-0 group-hover:pointer-events-auto group-focus-within:visible group-focus-within:opacity-100 group-focus-within:mt-0 group-focus-within:pointer-events-auto dark:bg-[#161821] dark:text-white">
            ...
            <li v-if="darkMode" class="inline-block px-2.5 2xl:px-[17px] py-[29px] group relative" role="none">
              <NuxtLink rel="noopener noreferrer"
                class="darkMain font-medium 2xl:text-[16px] flex items-center leading-snug text-secondary dark:text-white" to="#!"
                id="nav-2" role="menuitem" tabindex="0" aria-haspopup="true" aria-expanded="false">
                Pages<i class="fa fa-chevron-down ml-2 text-xs"></i></NuxtLink>
              <ul
                ...
                <li role="none" class="relative">
                  <NuxtLink class="flex items-center px-7.5 py-2" role="menuitem" to="/frontend-template/about/aboutme">
                    About me</NuxtLink>
                </li>
                <li role="none" class="relative">
                  <NuxtLink class="flex items-center px-7.5 py-2" role="menuitem"
                    to="/frontend-template/about/aboutusone">About us 01</NuxtLink>
                </li>
                <li role="none" class="relative">
                  <NuxtLink class="flex items-center px-7.5 py-2" role="menuitem"
                    to="/frontend-template/about/aboutustwo">About us 02</NuxtLink>
                </li>
                <li role="none" class="relative">
                  <NuxtLink class="flex items-center px-7.5 py-2" role="menuitem" to="/frontend-template/about/contactme">
                    Contact me</NuxtLink>
                </li>
                <li role="none" class="relative">
                  <NuxtLink class="flex items-center px-7.5 py-2" role="menuitem" to="/frontend-template/about/contactus">
                    Contact us</NuxtLink>
                </li>
                <li role="none" class="relative">
                  <NuxtLink class="flex items-center px-7.5 py-2" role="menuitem"
                    to="/frontend-template/about/loginregister">Login Register</NuxtLink>
                </li>
              </ul>
            </li>
            ...
            <li v-if="darkMode" class="inline-block px-2.5 2xl:px-[17px] py-[29px] group relative" role="none">
              <NuxtLink rel="noopener noreferrer"
                class="darkMain font-medium 2xl:text-[16px] flex items-center leading-snug text-secondary dark:text-white" to="#!"
                id="nav-3" role="menuitem" tabindex="0" aria-haspopup="true" aria-expanded="false">
                Courses<i class="fa fa-chevron-down ml-2 text-xs"></i></NuxtLink>
              <ul
                ...
                <li role="none" class="relative">
                  <NuxtLink class="flex items-center px-7.5 py-2" role="menuitem"
                    to="/frontend-template/courses/coursegridone">Courses Grid 01</NuxtLink>
                </li>
                <li role="none" class="relative">
                  <NuxtLink class="flex items-center px-7.5 py-2" role="menuitem"
                    to="/frontend-template/courses/coursegridtwo">Courses Grid 02</NuxtLink>
                </li>
                <li role="none" class="relative">
                  <NuxtLink class="flex items-center px-7.5 py-2" role="menuitem"
                    to="/frontend-template/courses/coursegridthree">Courses Grid 03</NuxtLink>
                </li>
                <!-- <li role="none" class="relative">
                  <NuxtLink class="
                        flex
                        ...
                        px-7.5
                        py-2
                      " role="menuitem" to="/frontend-template/membership-levels">Membership Levels</NuxtLink>
                </li>
                <li role="none" class="relative">
                  <NuxtLink class="
                        flex
                        ...
                        px-7.5
                        py-2
                      " role="menuitem" to="/become-a-teacher">Become a Teacher</NuxtLink>
                </li>
                <li role="none" class="relative">
                  <NuxtLink class="
                        flex
                        ...
                        px-7.5
                        py-2
                      " role="menuitem" to="/profile">Profile</NuxtLink>
                </li> -->
              </ul>
            </li>
            <li v-else class="inline-block px-2.5 2xl:px-[17px] py-[29px] group relative" role="none">
            ...
            <li v-if="darkMode" class="inline-block px-2.5 2xl:px-[17px] py-[29px] group relative" role="none">
              <NuxtLink rel="noopener noreferrer"
                class="darkMain font-medium 2xl:text-[16px] flex items-center leading-snug text-secondary dark:text-white" to="#!"
                id="nav-4" role="menuitem" tabindex="0" aria-haspopup="true" aria-expanded="false">
                Event<i class="fa fa-chevron-down ml-2 text-xs"></i></NuxtLink>
              <ul
                class="absolute z-20 top-full left-0 w-60 mt-5 py-4 transition-all duration-400 bg-white border-b-4 border-b-primary shadow-2md shadow-black/5 visible opacity-0 pointer-events-none group-hover:visible group-hover:opacity-100 group-hover:mt-0 group-hover:pointer-events-auto group-focus-within:visible group-focus-within:opacity-100 group-focus-within:mt-0 group-focus-within:pointer-events-auto dark:bg-[#161821] text-secondary dark:text-white"
                role="menu">
                <li role="none" class="relative">
                  <NuxtLink class="flex items-center px-7.5 py-2" role="menuitem" to="/frontend-template/event/events">
                    Event</NuxtLink>
                </li>
                <li role="none" class="relative">
                  <NuxtLink class="flex items-center px-7.5 py-2" role="menuitem"
                    to="/frontend-template/event/zoommeetings">Zoom Meetings</NuxtLink>
                </li>
              </ul>
            </li>
            <li v-else class="inline-block px-2.5 2xl:px-[17px] py-[29px] group relative" role="none">
            ...
            <li v-if="darkMode" class="inline-block px-2.5 2xl:px-[17px] py-[29px] group relative" role="none">
              <NuxtLink rel="noopener noreferrer"
                class=" darkMain font-medium 2xl:text-[16px] flex items-center leading-snug text-secondary dark:text-white" to="#!"
                id="nav-5" role="menuitem" tabindex="0" aria-haspopup="true" aria-expanded="false">
                Blog<i class="fa fa-chevron-down ml-2 text-xs"></i></NuxtLink>
              <ul
                class="absolute z-20 top-full left-0 w-60 mt-5 py-4 transition-all duration-400 bg-white border-b-4 border-b-primary shadow-2md shadow-black/5 visible opacity-0 pointer-events-none group-hover:visible group-hover:opacity-100 group-hover:mt-0 group-hover:pointer-events-auto group-focus-within:visible group-focus-within:opacity-100 group-focus-within:mt-0 group-focus-within:pointer-events-auto dark:bg-[#161821] text-secondary dark:text-white"
                role="menu">
                <li role="none" class="relative">
                  <NuxtLink class="flex items-center px-7.5 py-2 hover:text-[#20ad96] dark:hover:text-[#20ad96]" role="menuitem" to="/frontend-template/blog/bloggrid">
                    Blog Grid</NuxtLink>
                </li>
                <!-- <li role="none" class="relative">
                  <NuxtLink
            ...
            <li class="inline-block px-2.5 2xl:px-[17px] py-[29px] group" role="none">
              <NuxtLink class="font-medium 2xl:text-[16px] flex items-center leading-snug text-secondary dark:text-white hover:text-[#20ad96] dark:hover:text-[#20ad96]"
                id="nav-6" role="menuitem" tabindex="0" to="/frontend-template/about/contactus">Contact Us
              </NuxtLink>
            </li>
          </ul>
        </nav>
